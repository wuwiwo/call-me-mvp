...
// CM003_CHROME > CHROME_PATH > 常见安装位置 > which
const CHROME = resolveChrome(process.env.CM003_CHROME);
...
async function injectWithFetchStub(status, { brokenHistory }) {
    ...
    await evalJs(`(() => {
        ...
        localStorage.setItem("notificationHistory", ${JSON.stringify(brokenHistory)});
